  ...
  return (
    <div className="bg-[#0C0C0C] px-2 md:px-14 lg:px-[12%]  min-h-[100vh]">
      ...
      <div className="flex flex-col justify-top items-center h-auto w-full mt-[10%] mb-[5%]">
        ...
        <form name="Contact form : Contact page" id="Contact form : Contact page"className="rounded px-8 pt-4 md:pb-4 mb-4 w-[350px] md:w-[350px] pb-10" onSubmit={handleSubmit}>
